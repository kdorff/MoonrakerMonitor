...
ConfigManager::ConfigManager() { loadDefaultConfig(); }
...
void ConfigManager::loadDefaultConfig() {
  ...
  _config.disconnected = {0, 0xFF0000, 0x000000,
                          1000}; // Static Red (Same as Error by default)
}
...
AppConfig &ConfigManager::getConfig() { return _config; }
